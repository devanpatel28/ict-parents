...
import 'package:ict_mu_parents/Model/attendance_by_date_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AdaptiveRefreshIndicator(
        ...
        child: ListView(
          children: [
            controller.isLoadingAttendanceShow.value?AdaptiveLoadingScreen():Padding(
                ...
                child: Obx(
                  ()=> Column(
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            RadialIndicator(context, controller.avgAttendance),
                          ],
                        ),
                      ),
                      const Padding(
                      ...
                      controller.avgAttendance > 0 && controller.avgAttendance < 75
                          ? Column(
                        children: [
                          AnimatedBuilder(
                            animation: controller.animationController!.value, // Listen to the animation
                            builder: (BuildContext context, Widget? child) {
                              return Opacity(
                                opacity: controller.animationController!.value.value,
                                child: Card(
                                  color: Colors.red,
                                  child: SizedBox(
                        ...
                        children: [
                          ...
                          controller.todayAttendanceList.isNotEmpty
                            ...
                            itemBuilder: (context, index) {
                              ...
                              controller.todayAttendanceList[index];
                            ...
                            child: Container(
                              ...
                              child: Table(
                                ...
                                children: [
                                  ...
                                  ...controller.buildMergedTableRows(),
                                ],
                              ),
                            )),
                      )
